...
//   const nextNumber = containerEl.children.length + 1;
//   containerEl.insertAdjacentHTML(
//     "beforeend",
//     `<div class="box">${nextNumber}</div>`
//   );
// });
...
// страницы.
console.log(JSON.stringify(initialArticles));
...
listArticleEl.addEventListener('click', ({target})=>{
    if (target.matches(".btnDell")) {
        ...
        fatherEl.remove() // поднимается вверх пока не найдет селектор
